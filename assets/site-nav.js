...
(function () {
  ...
  // ===== CSS =====
  var css = '' +
    '.pa-site-nav{position:fixed;top:0;left:0;right:0;z-index:999;padding:22px 0;transition:background .35s,padding .35s,box-shadow .35s;}' +
    ...
    '.pa-site-nav-logo img{height:200px;width:auto;filter:invert(1);transition:filter .35s,height .3s;}' +
    '.pa-site-nav.solid .pa-site-nav-logo img{height:160px;filter:none;}' +
    ...
    '.pa-site-nav-btn{display:inline-flex;align-items:center;gap:8px;padding:13px 26px;border-radius:8px;font-size:14px;font-weight:600;text-decoration:none;transition:all .3s ease;}' +
    ...
    'body.pa-has-nav{padding-top:244px;}' +
    ...
    '@media (max-width:968px){' +
      ...
      '.pa-site-nav{padding:14px 0;}' +
      '.pa-site-nav-logo img{height:70px;}' +
      '.pa-site-nav.solid .pa-site-nav-logo img{height:56px;}' +
