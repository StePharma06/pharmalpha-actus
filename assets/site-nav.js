...
(function () {
  ...
  // ===== CSS =====
  var css = '' +
    '.pa-site-nav{position:fixed;top:0;left:0;right:0;z-index:999;padding:22px 0;background:#0a0a0a;transition:background .35s,padding .35s,box-shadow .35s;}' +
    '.pa-site-nav.solid{background:#fff;padding:14px 0;box-shadow:0 1px 24px rgba(0,0,0,.07);}' +
    '.pa-site-nav-inner{display:flex;align-items:center;justify-content:space-between;max-width:1200px;margin:0 auto;padding:0 28px;}' +
    '.pa-site-nav-logo{display:flex;align-items:center;}' +
    '.pa-site-nav-logo img{height:130px;width:auto;filter:invert(1);transition:filter .35s,height .3s;}' +
    '.pa-site-nav.solid .pa-site-nav-logo img{height:90px;filter:none;}' +
    '.pa-site-nav-links{display:flex;align-items:center;gap:4px;list-style:none;padding:0;margin:0;}' +
    '.pa-site-nav-links a{padding:8px 14px;font-size:14px;font-weight:500;color:rgba(255,255,255,.85);border-radius:6px;text-decoration:none;transition:all .3s ease;}' +
    ...
    '.pa-site-nav-right{display:flex;align-items:center;gap:12px;}' +
    '.pa-site-nav-btn{display:inline-flex;align-items:center;gap:8px;padding:13px 26px;border-radius:8px;font-size:14px;font-weight:600;text-decoration:none;transition:all .3s ease;white-space:nowrap;}' +
    ...
    '.pa-site-nav.solid .pa-site-nav-btn-ghost{color:#0a0a0a;border-color:rgba(0,0,0,.15);}' +
    '.pa-site-nav.solid .pa-site-nav-btn-ghost:hover{border-color:#0a0a0a;background:rgba(0,0,0,.04);}' +
    ...
    'body.pa-has-nav{padding-top:174px;}' +
    ...
    '@media (max-width:968px){' +
      'body.pa-has-nav{padding-top:88px;}' +
      '.pa-site-nav{padding:12px 0;}' +
      '.pa-site-nav-logo img{height:64px;}' +
      '.pa-site-nav.solid .pa-site-nav-logo img{height:50px;}' +
      '.pa-site-nav-links{display:none;}' +
      '.pa-site-nav-right .pa-site-nav-btn{display:none;}' +
      '.pa-site-nav-hamburger{display:flex;}' +
    '}' +
    '.pa-mobile-menu{display:none;position:fixed;inset:0;z-index:1000;background:#0a0a0a;flex-direction:column;align-items:center;justify-content:center;gap:28px;}' +
    ...
    '<nav class="pa-site-nav" id="paSiteNav">' +
      '<div class="pa-site-nav-inner">' +
        ...
        '<div class="pa-site-nav-right">' +
          ...
          '<a href="' + ROOT + '/#contact" class="pa-site-nav-btn pa-site-nav-btn-orange">Me contacter</a>' +
